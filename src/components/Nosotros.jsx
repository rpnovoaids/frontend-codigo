    ...
    <>
      <section className="nosotros">
        <div className="nosotros-container">
          ...
          <p className="nosotros-about">
            A través del portal Artesaner se busca brindar un espacio de
            encuentro entre artesanas y artesanos de Perú, representantes del
            mundo del diseño, moda y cultura, para fortalecer y promocionar la
            artesanía textil. Artesaner es un portal especializado que responde
            a la demanda de artesanía textil, sector con gran potencial que
            involucra a más de 3 millones de familias rurales y periurbanas en
            situación de pobreza en Perú. Las secciones del portal incluyen
            ropa, accesorios, reviews, contactos, directorio de artesanos,
            diseñadores, tienda virtual.
          </p>
          <h2 className="nosotros-subtitle">Nuestra Historia</h2>
          <p className="nosotros-about">
            El portal nace a partir del trabajo realizado por los estudiantes
                ...
                <div className="staff__container">
                  <figure className="staff__img-container">
                    <img
                      ...
                      src="https://i.postimg.cc/2yvPzhxf/Whats-App-Image-2022-03-30-at-12-36-37-PM.jpg"
                      alt="Writhney Lazo"
                    />
                  </figure>
                  <figcaption className="staff__info-container">
                    <h3 className="staff__info-title">Writhney Lazo</h3>
                    <div className="staff__info-line-container">
                      <img className="staff__info-line" src={Line}></img>
                    </div>
                    <p className="staff-info-about">
                ...
                <div className="staff__container">
                  <figure className="staff__img-container">
                    <img
                      className="staff__img"
                      width="70px"
                      src="https://avatars.githubusercontent.com/u/64298891?v=4"
                      alt="Robert Quilca"
                    />
                  </figure>
                  <figcaption className="staff__info-container">
